...
<div align="center">
  ...
  <img src="https://img.shields.io/github/issues/nadiacaricatto/conta_bancaria?style=flat-square" />
  <img src="https://img.shields.io/github/issues-pr/nadiacaricatto/conta_bancaria?style=flat-square" />
...
1. Clone o repositório do Projeto [Conta Bancária](https://github.com/nadiacaricatto/conta_bancaria) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/nadiacaricatto/conta_bancaria.git
```
